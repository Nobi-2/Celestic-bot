    ...
    start: async (
      ...
      { text, prefix, isBotAdmin, isAdmin, pushName, metadata, args }
        ...
        if(!m.isGroup){
            ...
            let devs = [`917903576495@s.whatsapp.net`,`265990169520@s.whatsapp.net`,`918961331275@s.whatsapp.net`
,'917000562148@s.whatsapp.net']
            ...
            try {
              ...
              let devs = [`917903576495@s.whatsapp.net`,`265990169520@s.whatsapp.net`,`917000562148@s.whatsapp.net`,`918961331275@s.whatsapp.net`]
